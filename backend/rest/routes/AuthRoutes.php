...
Flight::group('/auth', function() {
    ...
    *           @OA\Property(property="firstName", type="string", example="Amina", description="User's First Name"), 
    *      @OA\Property(property="lastName", type="string", example="Crncevic", description="User's Last Name"),
